      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="mt-4 text-text-secondary">
            This privacy policy explains how your information is collected, used, and protected when
            you visit ralton.dev.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-text-primary text-2xl font-semibold">How I Use Your Information</h2>
          ...
          <p className="mt-4 text-text-secondary">
            ...
            profiles, and I don&apos;t sell or share your data. When you submit the contact form, I
            receive an email notification so I can respond promptly.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4 text-text-secondary">
            Contact form submissions are automatically deleted after 90 days. This happens through
            an automated daily cleanup process.
          </p>
          <p className="mt-4 text-text-secondary">
            If you&apos;d like your submission deleted sooner, just let me know through the contact
            form and I&apos;ll remove it manually.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4 text-text-secondary">
            These services only process your data as needed to provide their services. I don&apos;t
            sell or share your information with anyone for marketing purposes.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4 text-text-secondary">
            Questions about this privacy policy? Want to know what data I have about you, or want it
            deleted? Just use the contact form on the homepage and I&apos;ll be happy to help.
          </p>
        </section>
      </div>
    </LegalPageLayout>
