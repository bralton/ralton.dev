 ...
 * Statically generated at build time for all categories.
 *
 * Features:
 * - Filter posts by category relationship
...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  const description =
    category.description || `Articles and insights about ${category.name} by Ben Ralton.`
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${category.name} - Ben Ralton's Blog`,
        },
      ],
    },
    twitter: {
  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-24">
        <section aria-labelledby="category-heading" className="px-4 py-16 md:px-6 md:py-24 lg:px-8">
